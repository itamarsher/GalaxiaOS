...
_VISUAL_SYSTEM = (
    ...
    "cohesive and on-brand?), imagery quality, overall polish, copy clarity, and conversion "
    "(does the primary call-to-action stand out?). APPROVE only if a discerning designer would "
    "ship it unchanged. If anything looks generic, cluttered, low-contrast, off-brand, or "
    "unpolished, do NOT approve.\n\n"
